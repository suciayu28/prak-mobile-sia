...
class TabQrcodeFragment : Fragment() {
    ...
    // 🛠️ TAMBAHAN FUNCTION onViewCreated SESUAI MODUL LANGKAH 3
    ...
    // 🛠️ TAMBAHAN FUNCTION createQR UNTUK MEMBUAT GENERATOR QR CODE DENGAN ZXING
    private fun createQR(text: String): Bitmap { //
        val writer = QRCodeWriter() //
        val matrix = writer.encode( //
            text,
            BarcodeFormat.QR_CODE, // Dipastikan import milik com.google.zxing
            500,
            500,
